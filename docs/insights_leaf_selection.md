...
> Position in the paper: **Supplementary (6.1)**. Reads after `addition3_results.md`; precedes `the paper's TRIPOD+AI and PROBAST+AI checklists`. Composite_sorted selection rule, its parameters, and the within-family fragility sensitivity sweep results.
