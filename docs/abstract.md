...
**Word count.** Title 17 words. Abstract 450 words (at the JHP cap; CI-density + demographic-narrowness disclosures per writing_guide §10.1 and §10.11 plus the T2-2 patient-cluster sensitivity framing on AUROC / slope / CITL / Brier skill).
