"""HP variant train: target={target}, ratio={ratio}, split_type={split_type},
tuning_strategy={tuning_strategy}, tuning_variant={tuning_variant}.
...
{read_imports}
{extra_imports}from _model_architecture.stacked_2xgb_meta_lr_hp import model as hp_model  # noqa: E402
...
PARETO_X_KEY    = "{pareto_x_key}"   # empty string for single-objective
PARETO_Y_KEY    = "{pareto_y_key}"
