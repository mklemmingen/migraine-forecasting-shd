"""HP variant train (2-way ratio): target={target}, ratio={ratio},
split_type={split_type}, tuning_strategy={tuning_strategy},
...
def main():
    with capture_training_output(EXPERIMENT_DIR, label='training'):
        ...
        df_train_full = load_raw(TRAIN_PATH, loader={raw_loader})
