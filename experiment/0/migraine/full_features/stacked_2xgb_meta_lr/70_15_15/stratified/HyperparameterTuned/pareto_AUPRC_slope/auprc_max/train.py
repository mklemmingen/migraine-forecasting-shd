"""HP variant train: target=migraine, ratio=70_15_15, split_type=stratified,
tuning_strategy=pareto_AUPRC_slope, tuning_variant=auprc_max.
...
TUNING_STRATEGY = "pareto_AUPRC_slope"
TUNING_VARIANT  = "auprc_max"
PARETO_X_KEY    = "auprc"   # empty string for single-objective
