"""HP variant train: target=headache, ratio=70_15_15, split_type=stratified,
tuning_strategy=pareto_AUROC_slope, tuning_variant=auroc_max.
...
TUNING_VARIANT  = "auroc_max"
PARETO_X_KEY    = "auroc"   # empty string for single-objective
