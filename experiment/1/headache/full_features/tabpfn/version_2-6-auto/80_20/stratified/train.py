...
from _model_architecture.autotabpfn.model import build_autotabpfn  # noqa: E402
...
def main():
    with capture_training_output(EXPERIMENT_DIR, label='training'):
        ...
        print("Fitting tabpfn (version_2-6-auto) on full train (no external calibrator - see docs/tabPfn.MD)...")
