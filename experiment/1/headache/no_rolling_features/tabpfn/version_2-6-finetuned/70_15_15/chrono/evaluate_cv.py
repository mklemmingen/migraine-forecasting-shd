"""
5-fold time-series cross-validation for tabpfn (version_2-6-finetuned).
...
TITLE         = (
    "STAGE 1 / no_rolling_features / tabpfn (version_2-6-finetuned) - "
...
def _main_inner():
    ...
    cv = remove_rolling_features(CV_PATH)
