"""
5-fold time-series cross-validation for tabpfn (version_3-default).
...
TITLE         = (
    "STAGE 1 / park_features / tabpfn (version_3-default) - "
...
def _main_inner():
    ...
    for fold in range(1, N_SPLITS + 1):
        ...
        model = build_tabpfn_v3(X_train_sub, y_train_sub, output_dir=EXPERIMENT_DIR)
