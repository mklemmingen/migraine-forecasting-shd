"""
5-fold time-series cross-validation for tabpfn (version_2-5-finetuned).
...
from _model_architecture.finetunedtabpfn_v2_5.model import build_finetunedtabpfn  # noqa: E402
...
TITLE         = (
    "STAGE 1 / park_features / tabpfn (version_2-5-finetuned) - "
...
def _main_inner():
    ...
    for fold in range(1, N_SPLITS + 1):
        ...
        model = build_finetunedtabpfn(X_train_sub, y_train_sub, output_dir=EXPERIMENT_DIR)
