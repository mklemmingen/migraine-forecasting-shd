...
TRAIN_PATH = os.path.join(DATA_DIR, "80_20", "patient", "diary_train.parquet")
TEST_PATH  = os.path.join(DATA_DIR, "80_20", "patient", "diary_test.parquet")
MODEL_PATH = os.path.join(EXPERIMENT_DIR, "model.joblib")

RESULT_PREFIX = "results"
TITLE         = "STAGE 1 / park_features / tabpfn (version_2-5-finetuned)"
...
def main():
    ...
    X_test, y_test = load_and_prep_data(TEST_PATH, loader=select_park_features)
