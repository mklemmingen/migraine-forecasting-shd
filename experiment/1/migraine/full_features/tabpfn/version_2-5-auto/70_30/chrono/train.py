...
from _model_architecture.autotabpfn_v2_5.model import build_autotabpfn  # noqa: E402
...
def main():
    with capture_training_output(EXPERIMENT_DIR, label='training'):
        ...
        print("Fitting tabpfn (version_2-5-auto) on full train (no external calibrator - see docs/tabPfn.MD)...")
        model = build_autotabpfn(X_train, y_train, output_dir=EXPERIMENT_DIR)
