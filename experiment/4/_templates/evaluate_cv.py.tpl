"""
5-fold time-series cross-validation for sequence (version_{version_label}).
...
{extra_imports}from _seq.dataread import seq_split  # noqa: E402
from _model_architecture.{module}.model import {build_fn}  # noqa: E402
...
TITLE         = (
    "STAGE {addition} / {feature_set} / sequence (version_{version_label}) - "
