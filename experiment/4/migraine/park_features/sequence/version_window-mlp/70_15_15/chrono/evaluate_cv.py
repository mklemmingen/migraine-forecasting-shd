"""
5-fold time-series cross-validation for sequence (version_window-mlp).
...
TITLE         = (
    "STAGE 4 / park_features / sequence (version_window-mlp) - "
...
def _main_inner():
    ...
    for fold in range(1, N_SPLITS + 1):
        ...
        model = build_window_mlp(X_train_sub, y_train_sub, output_dir=EXPERIMENT_DIR)
