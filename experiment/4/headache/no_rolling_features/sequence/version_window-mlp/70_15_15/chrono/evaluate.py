...
TITLE         = "STAGE 4 / no_rolling_features / sequence (version_window-mlp)"


def main():
    print("Loading datasets and model (id-bearing X for windowing)...")
    X_val,  y_val  = load_seq(VAL_PATH,  loader=select_non_rolling_features)
    X_test, y_test = load_seq(TEST_PATH, loader=select_non_rolling_features)
